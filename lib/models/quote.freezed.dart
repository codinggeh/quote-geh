...
class _$QuoteImpl implements _Quote {
  const _$QuoteImpl(
      {@JsonKey(name: 'q') required this.text,
      @JsonKey(name: 'a') required this.author,
      @JsonKey(name: 'h') this.html});
  ...
  @override
  String toString() {
    return 'Quote(text: $text, author: $author, html: $html)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, text, author, html);
...
abstract class _Quote implements Quote {
  const factory _Quote(
      {@JsonKey(name: 'q') required final String text,
      @JsonKey(name: 'a') required final String author,
      @JsonKey(name: 'h') final String? html}) = _$QuoteImpl;
